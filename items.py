		...
		for item in item_ref:
			if(id == item[0]):
				if(count == 1):
					...
					return "{{" + item[1] + "|{{subst:formatnum:" + str(count) + "}}}}"
		return " [https://apps.atlasacademy.io/db/JP/item/" + str(id) + " Item #" + str(id) + " ×" + str(count) + "]"
	elif(type == "servant"):
		return " [https://apps.atlasacademy.io/db/JP/enemy/" + str(id) + " EXP Card " + str(id) + " ×" + str(count) + "]"
